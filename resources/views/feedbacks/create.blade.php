<x-admin-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Create a new feedback/testimonial from customer</p>
            </div>
    ...
    <div class="max-w-4xl mx-auto">
        <form action="{{ route('feedbacks.store') }}" method="POST" enctype="multipart/form-data" id="feedbackCreateForm">
            @csrf
            ...
            <div class="card mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">Select the order related to this feedback (completed orders only)</p>
                    </div>
            ...
            <div class="flex items-center justify-between bg-gray-50 px-6 py-4 rounded-lg">
                ...
                <button 
                    ...
                    <span :class="{'opacity-10': loading}">Create Feedback</span>
                </button>
            </div>
        </form>
    </div>

<x-admin-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Create a new land record with details and photo</p>
            </div>
    ...
    <div class="max-w-4xl mx-auto">
        <form action="{{ route('lands.store') }}" method="POST" enctype="multipart/form-data" x-data="{ loading: false }" @submit="loading = true" id="landCreateForm">
            @csrf
            ...
            <div class="flex items-center justify-end gap-x-4">
                ...
                <button type="submit" class="btn btn-primary" :disabled="loading">
                    ...
                    <span :class="{'opacity-0': loading}">Create Land</span>
                </button>
            </div>
        </form>
    </div>

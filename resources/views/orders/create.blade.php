                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="date" name="dt" id="dt" class="form-input @error('dt') border-red-500 @enderror" 
                                   value="{{ old('dt', date('Y-m-d')) }}" required>
                            @error('dt')
                        ...
                        <div>
                            ...
                            <select name="cluster_id" id="cluster_id" class="form-input @error('cluster_id') border-red-500 @enderror" required disabled>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="unit_id" id="unit_id" class="form-input @error('unit_id') border-red-500 @enderror" required disabled>

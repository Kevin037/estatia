<x-admin-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Update property type information</p>
            </div>
    ...
    <div class="max-w-4xl mx-auto">
        <form action="{{ route('types.update', $type->id) }}" method="POST" id="typeEditForm">
            @csrf
            @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            name="land_area" 
                            id="land_area" 
                            value="{{ old('land_area', $type->land_area) }}"
                            step="0.01"
                            min="0"
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            name="building_area" 
                            id="building_area" 
                            value="{{ old('building_area', $type->building_area) }}"
                            step="0.01"
                            min="0"
            ...
            <div class="flex items-center justify-between bg-gray-50 px-6 py-4 rounded-lg">
                ...
                <button 
                    ...
                    <span :class="{'opacity-10': loading}">Update Type</span>
                </button>
            </div>
        </form>
    </div>

<x-admin-layout>
    ...
    <div id="filterCard" class="card mb-6" style="display: none;">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Filter Milestones</h3>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#exportBtn').click(function() {
                ...
                let url = "{{ route('milestones.export') }}";
            ...
            $(document).on('click', '.delete-milestone', function(e) {
                ...
                const milestoneName = $(this).data('name');
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            error: function(xhr) {
                                Swal.fire(
                                    'Error!',
                                    xhr.responseJSON.message || 'Failed to delete milestone.',
                                    'error'
                                );
                            }
                        });

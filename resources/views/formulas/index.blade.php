<x-admin-layout>
    ...
    <div id="filterCard" class="card mb-6" style="display: none;">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Filter Formulas</h3>
    ...
    <div class="card">
        <div class="table-container">
            <table id="formulasTable" class="table">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Formula Code</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            const table = $('#formulasTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                ...
                language: {
                    ...
                    zeroRecords: "No matching formulas found"
                }
            });
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            error: function(xhr) {
                                Swal.fire(
                                    'Error!',
                                    xhr.responseJSON?.message || 'Failed to delete formula.',
                                    'error'
                                );
                            }
                        });

<x-admin-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Manage construction projects with clusters and units</p>
            </div>
    ...
    <div id="filterCard" class="card mb-6" style="display: none;">
        ...
        <form id="filterForm" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                <label for="filter_start_date" class="form-label">Start Date From</label>
                <input 
                    type="date" 
            ...
            <div>
                <label for="filter_end_date" class="form-label">End Date To</label>
                <input 
                    type="date" 
                    id="filter_end_date" 
                    name="end_date" 
        ...
        $(document).ready(function() {
            ...
            const table = $('#projectsTable').DataTable({
                ...
                columns: [
                    ...
                    { data: 'dt_start', name: 'dt_start' },
                    { data: 'customer', name: 'land.address' },
            ...
            $(document).on('click', '.delete-project', function(e) {
                ...
                Swal.fire({
                    ...
                    html: `Are you sure you want to delete project <strong>${name}</strong>?<br><span class="text-sm text-gray-600">This will also delete all clusters and units.</span>`,
                    icon: 'warning',

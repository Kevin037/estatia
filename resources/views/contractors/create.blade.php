<x-admin-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Create a new contractor with contact information</p>
            </div>
    ...
    <div class="max-w-4xl mx-auto">
        <form action="{{ route('contractors.store') }}" method="POST" id="contractorCreateForm">
            @csrf
            ...
            <div class="flex items-center justify-between bg-gray-50 px-6 py-4 rounded-lg">
                ...
                <button 
                    ...
                    <span :class="{'opacity-10': loading}">Create Contractor</span>
                </button>
            </div>
        </form>
    </div>

<x-admin-layout>
    ...
    <div id="filterCard" class="card mb-6" style="display: none;">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Filter Contractors</h3>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#exportBtn').click(function() {
                ...
                let url = "{{ route('contractors.export') }}";
            ...
            $(document).on('click', '.delete-contractor', function(e) {
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: `You are about to delete contractor: ${name}`,
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function(response) {
                                Swal.fire(
                                    'Deleted!',
                                    response.message || 'Contractor has been deleted.',
                                    'success'
                                );
                                table.ajax.reload();
                            },
                            error: function(xhr) {
                                Swal.fire(
                                    'Error!',
                                    xhr.responseJSON.message || 'Failed to delete contractor.',
                                    'error'
                                );
                            }
                        });

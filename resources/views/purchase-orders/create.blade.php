<x-admin-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Create a new purchase order for material procurement</p>
            </div>
        ...
        <form action="{{ route('purchase-orders.store') }}" method="POST" id="purchaseOrderForm">
            ...
            <div class="flex items-center justify-between bg-gray-50 px-6 py-4 rounded-lg">
                ...
                >
                    ...
                    <span :class="{'opacity-10': loading}">Create Purchase Order</span>
                </button>
            </div>
        </form>
    </div>
    ...
    <script>
        function materialManager() {
            return {
                rows: [{ id: Date.now(), material_id: '', price: 0, qty: 0, subtotal: 0, error: '' }],
        ...
        $(document).ready(function() {
            ...
            $('#supplier_id').on('change', function() {
                ...
                // You can implement supplier filtering here if needed
            });
        });
    </script>
    @endpush

<x-admin-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Create a new sales record with contact information</p>
            </div>
    ...
    <div class="max-w-4xl mx-auto">
        <form action="{{ route('sales.store') }}" method="POST" id="saleCreateForm">
            @csrf

            <!-- Sale Information Section -->
            <div class="card mb-6">
                <div class="card-header">
                    <h3 class="text-lg font-semibold text-gray-900">Sales Information</h3>
                    <p class="mt-1 text-sm text-gray-600">Basic details about the salesperson</p>
                </div>
